...
const demoPlans: BillingPlan[] = [
  {
    id: "starter",
    name: "Solo",
    description: "For freelancers and independent consultants",
    priceMonthly: 19,
    currency: "USD",
    features: ["1 user", "500 AI requests/mo", "CRM + proposals"],
  },
  {
    id: "pro",
    name: "Business",
    ...
    priceMonthly: 49,
    currency: "USD",
    features: ["5 users", "3,000 AI requests/mo", "Support + automations"],
    highlighted: true,
    recommended: true,
  },
  {
    id: "business",
    name: "Agency",
    description: "For agencies managing more clients",
    priceMonthly: 99,
    currency: "USD",
    features: ["15 users", "10,000 AI requests/mo", "Priority support"],
  },
  {
    id: "enterprise",
    name: "Enterprise",
